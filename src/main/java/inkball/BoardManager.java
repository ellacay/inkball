...
public class BoardManager {
    ...
    private void handleBallCell(int x, int y, float xPos, float yPos, float xPosOffset) {
        if (x + 1 < board[y].length) {
            ...
            app.image(imageLoader.tile, xPos, yPos);
            switch (nextCell) {
                case '0': app.image(imageLoader.ball0, xPos, yPos); break;
                case '1': app.image(imageLoader.ball1, xPos, yPos); break;
                case '2': app.image(imageLoader.ball2, xPos, yPos); break;
                case '3': app.image(imageLoader.ball3, xPos, yPos); break;
                case '4': app.image(imageLoader.ball4, xPos, yPos); break;
